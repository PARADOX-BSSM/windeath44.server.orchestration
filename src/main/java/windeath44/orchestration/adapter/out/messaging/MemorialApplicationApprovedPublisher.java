...
public class MemorialApplicationApprovedPublisher implements MemorialApplicationEventPublisher {
  private final KafkaProducer kafkaProducer;

  @Override
  public <T extends SpecificRecord> void publish(T memorialAvroSchema) {
    String topic = Topic.MEMORIAL_APPLICATION_APPROVED.getTopicName();
    kafkaProducer.send(topic, memorialAvroSchema);
  }

  @Override
  public MemorialApplicationAction getAction() {
    return MemorialApplicationAction.APPROVE;
  }
}
